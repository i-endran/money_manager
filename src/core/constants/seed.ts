...
export const SEED_CATEGORIES: SeedCategory[] = [
    ...
    { name: '🍽️ Meals', type: CategoryType.EXPENSE, iconName: 'restaurant-menu', level: 2, parentRef: '🍕 Food' },
    ...
    { name: '🛍️ Shopping', type: CategoryType.EXPENSE, iconName: 'shopping-bag', level: 1 },
